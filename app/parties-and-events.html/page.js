...
export const metadata = {
  ...
  openGraph: {
    type: "website",
    siteName: "Cipher & Key",
    url: "https://www.cipherandkey.com/parties-and-events.html",
    title: "Parties & Events — Cipher & Key Springfield",
    description: "Find out why Cipher & Key is one of the top things to do in Springfield! Book our escape rooms for birthday parties, celebrations and corporate teambuilding.",
    images: "https://www.cipherandkey.com/images/groups-birthday.webp",
  },
  ...
  <section className="section-tight section-alt">
    <div className="container" style={{display: 'flex', gap: '52px', alignItems: 'flex-start'}} data-split>
      <div style={{flex: '1.3', display: 'flex', flexDirection: 'column', gap: '16px'}}>
        ...
        <p style={{fontSize: '16px', lineHeight: '1.7', margin: '0'}}>We have a great idea for your next birthday party or event. Try an escape room! Whether you're celebrating a "Sweet Sixteen" a "Fabulous at Fifty," or just getting together with friends, make Cipher & Key your destination.</p>
      ...
      <div style={{width: '440px', flexShrink: '0', display: 'flex', flexDirection: 'column', gap: '16px'}}>
        <div style={{borderRadius: 'var(--radius)', overflow: 'hidden'}}><img src="/images/groups-birthday-sm.webp" alt="A birthday party group at Cipher & Key" loading="lazy" /></div>
      ...
      <div className="compare-wrap">
        <table className="compare">
          ...
          <tbody>
            ...
            <tr><td className="room-name">8 players</td><td><strong>$239.60</strong></td><td>$29.95 per person · The Vanishing Hour or Dinner at Eight</td><td><Link className="btn btn-primary btn-sm" href="/book-a-game.html">Book Now</Link></td></tr>
            <tr><td className="room-name">Up to 24</td><td>Two rooms, head-to-head</td><td>A friendly competition across two games</td><td><a className="btn btn-outline btn-sm" href="tel:2175550182">Call to plan</a></td></tr>
            <tr><td className="room-name">Whole facility</td><td>Call for rates</td><td>Private full-facility rental at a premium — <a className="text-link" href="tel:2175550182">(217) 555-0182</a></td><td><a className="btn btn-outline btn-sm" href="tel:2175550182">Call us</a></td></tr>
          </tbody>
        </table>
      </div>
    ...
    <div className="container" style={{display: 'flex', gap: '32px', alignItems: 'flex-start'}} data-split>
      <div style={{flex: '1', display: 'flex', flexDirection: 'column', gap: '16px'}}>
        ...
        <div className="panel panel-dark panel-pad" style={{display: 'flex', flexDirection: 'column', gap: '10px'}}>
          ...
          <p style={{fontSize: '15px', lineHeight: '1.65', margin: '0'}}>Call <a href="tel:2175550182" style={{color: 'var(--red-bright)', fontWeight: '700'}}>(217) 555-0182</a> — we may be mid-game, so leave a message and our event planner will call you back.</p>
        </div>
      </div>
