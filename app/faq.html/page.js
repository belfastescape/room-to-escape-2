...
export const metadata = {
  title: "Escape Room | FAQ - Room to Escape | Fort Wayne Room to Escape",
  description: "Located in Fort Wayne, we offer five unique escape rooms with varying levels of difficulty for families, friends, and coworkers to enjoy. Book now!",
  alternates: { canonical: "/faq.html" },
  openGraph: {
    type: "website",
    siteName: "Room to Escape",
    url: "https://www.roomtoescape.com/faq.html",
    title: "FAQ — Room to Escape Fort Wayne",
    description: "Located in Fort Wayne, we offer five unique escape rooms with varying levels of difficulty for families, friends, and coworkers to enjoy. Book now!",
    images: "https://www.roomtoescape.com/images/home-venue.webp",
  },
  ...
  <section className="section-tight section-alt">
    <div className="container" style={{maxWidth: '860px'}}>
      ...
      <details className="faq-item">
        ...
        <div className="answer">We are located at 3734 Allen Ave, Fort Wayne, IN 46805. Just off of the intersection of Clinton and Coldwater, south of Coliseum and across from Granite City.</div>
      </details>
      <details className="faq-item">
      ...
      <details className="faq-item">
        ...
        <div className="answer">Yes, we accommodate large parties and corporate groups frequently in our Fort Wayne escape rooms. Please visit our website to book your games. If you would like help booking your large group or would like to rent out our facility at a premium please contact us directly by calling <a className="text-link" href="tel:2606938836">260-693-8836</a>.</div>
      </details>
      <details className="faq-item">
      ...
      <div className="notice" style={{marginTop: '26px'}}>
        <strong>Still curious?</strong> Call <a className="text-link" href="tel:2606938836">260-693-8836</a> or use the <Link className="text-link" href="/contact.html">contact form</Link> — we may be working a game, so please leave a message.
      </div>
    </div>
  </section>
